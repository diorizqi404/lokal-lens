...
export default function BudayaTerancamSuksesPage() {
  return (
    <main className="min-h-screen bg-white flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-[832px] p-8 sm:p-12 flex flex-col items-stretch rounded-xl border border-[#E5E2DC] bg-white shadow-[0_10px_15px_-3px_rgba(0,0,0,0.10),0_4px_6px_-4px_rgba(0,0,0,0.10)]">
        <div className="flex flex-col items-center gap-8">
          <div className="w-24 h-24 flex items-center justify-center rounded-full bg-[#DCFCE7]">
          ...
          <div className="w-full max-w-[576px] p-4 flex flex-col items-center rounded-lg border border-[#BFDBFE] bg-[#EFF6FF]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
            <Link 
              href="/profil"
              className="w-full sm:w-auto px-6 py-3 flex items-center justify-center rounded-lg bg-[#006C84] hover:bg-[#005266] transition-colors"
            >
              <span className="text-white text-center font-bold text-base leading-6">
                Lihat Laporan Saya
              </span>
            </Link>
