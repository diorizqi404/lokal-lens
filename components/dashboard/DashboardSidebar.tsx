...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      {
        name: 'Laporan Budaya',
        href: '/dashboard/admin/manajemen/laporan-budaya',
        icon: (
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {
        name: 'Sertifikat',
        href: '/dashboard/admin/manajemen/sertifikat',
        icon: (
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2L9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27 18.18 21l-1.63-7.03L22 9.24l-7.19-.61L12 2z" fill="currentColor"/>
          </svg>
      ...
      {
        name: 'Verifikasi',
        href: '/dashboard/admin/manajemen/verifikasi',
        icon: (
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {
        name: 'Riwayat Scan',
        href: '/dashboard/admin/manajemen/riwayat-scan',
        icon: (
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
