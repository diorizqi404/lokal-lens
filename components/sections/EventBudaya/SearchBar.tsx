...
export default function SearchBar({ onSearch }: SearchBarProps) {
  ...
  return (
    <div className="w-full mb-4 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
      <form onSubmit={handleSubmit} className="bg-white border border-[#EAE3D9] rounded-xl shadow-sm overflow-hidden transition-shadow duration-300 hover:shadow-md">
        <div className="flex items-center gap-3 px-4 py-3.5">
          ...
          {query && (
            <button
              ...
              className="text-[#5C6B8A] hover:text-[#192A51] transition-colors"
            >
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 8.58579L13.5858 5L15 6.41421L11.4142 10L15 13.5858L13.5858 15L10 11.4142L6.41421 15L5 13.5858L8.58579 10L5 6.41421L6.41421 5L10 8.58579Z" fill="currentColor"/>
              </svg>
            </button>
          )}
        </div>
