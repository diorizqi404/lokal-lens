  ...
  const events = [
    {
      ...
      title: "Festival Kesenian Tradisional Nusantara 2024",
      location: "Jakarta Convention Center",
      date: "15-17 Desember 2024",
      description: "Rayakan keberagaman budaya Indonesia dengan pertunjukan seni, pameran kerajinan, dan kuliner tradisional dari berbagai daerah."
    },
    {
      image: "/assets/img/product.png",
      category: "Workshop",
      title: "Workshop Batik Tulis Keraton Solo",
      location: "Museum Batik Yogyakarta",
      date: "22 Desember 2024",
      description: "Belajar teknik membatik tulis langsung dari pengrajin batik keraton dengan motif-motif klasik Jawa yang penuh makna."
    },
    {
      image: "/assets/img/product.png",
      category: "Pameran",
      title: "Pameran Tenun Ikat Nusantara",
      location: "Galeri Nasional Indonesia",
      date: "10-31 Januari 2025",
      description: "Pameran koleksi kain tenun ikat dari berbagai daerah di Indonesia, menampilkan keindahan dan filosofi di balik setiap motif."
    },
    {
      image: "/assets/img/product.png",
      category: "Festival Budaya",
      title: "Karnaval Budaya Pesisir Nusantara",
      location: "Pantai Ancol, Jakarta",
      date: "5 Februari 2025",
      description: "Karnaval megah menampilkan tarian, musik, dan kostum tradisional dari berbagai komunitas pesisir Indonesia."
    },
    {
      image: "/assets/img/product.png",
      category: "Workshop",
      title: "Kelas Ukiran Kayu Tradisional Jepara",
      location: "Sanggar Seni Jepara",
      date: "12 Februari 2025",
      description: "Workshop intensif teknik ukiran kayu Jepara untuk pemula hingga menengah, dipandu oleh pengrajin berpengalaman."
    }
  ];
  ...
  return (
    <section className="w-full py-12 sm:py-16 lg:py-[126px]">
      <div className="flex flex-col items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="overflow-hidden">
            ...
            >
              {events.map((event, index) => (
                <div
                  key={index}
                  className="w-full sm:w-1/2 lg:w-1/3 shrink-0 flex flex-col rounded-2xl lg:rounded-4xl border border-[#E5E7EB] bg-white shadow-sm hover:shadow-lg transition-shadow"
                >
                  <div className="relative h-60">
                    ...
                    />
                    <div className="absolute top-3 left-3 px-3 py-1 rounded-full bg-[#D4A017] backdrop-blur-sm">
                  ...
                  <div className="flex flex-col gap-3 sm:gap-4 p-4 sm:p-5">
                    ...
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-[#6B7280]">{event.date}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="text-sm font-medium text-[#6B7280]">{event.location}</span>
                      </div>
                    </div>
        ...
        <Link href="/event-budaya" className="flex items-center gap-2 px-6 sm:px-[34px] py-3 sm:py-[13px] rounded-full border-2 border-[#D4A017] hover:bg-[#D4A017] hover:text-white transition-colors mt-8 group">
